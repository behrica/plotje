    ...
    (and
     ...
     (let
      ...
      (and
       ...
       (every?
        (fn* [p1__89768#] (= :petal-length (:x p1__89768#)))
        layers)
       (every?
        (fn* [p1__89769#] (= :petal-width (:y p1__89769#)))
        layers)
       (every?
        (fn* [p1__89770#] (= :species (:color p1__89770#)))
        layers)))
     (= {} (:opts d))))
   v14_l200)))
  ...
  ((fn
    ...
    (and
     ...
     (every?
      (fn*
       [p1__89771#]
       (.startsWith (.getName (class p1__89771#)) "membrane.ui."))
      (:drawables v))))
   v27_l258)))
    ...
    (let
     ...
     (and
      ...
      (=
       ...
       (count
        (filter
         (fn* [p1__89772#] (.startsWith p1__89772# "rgb"))
         (:colors s)))))))
   v40_l436)))
