...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__92544#] (= 50 (:n-points p1__92544#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__92545#] (< (:lo p1__92545#) (:hi p1__92545#)))
      bars)
     (every? (fn* [p1__92546#] (pos? (:count p1__92546#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__92547#] (Math/sin (* p1__92547# 0.3))) (range 30))}))
