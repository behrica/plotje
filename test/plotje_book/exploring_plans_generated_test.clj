...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__89921#] (= 50 (:n-points p1__89921#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__89922#] (< (:lo p1__89922#) (:hi p1__89922#)))
      bars)
     (every? (fn* [p1__89923#] (pos? (:count p1__89923#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__89924#] (Math/sin (* p1__89924# 0.3))) (range 30))}))
