...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__88084#] (Math/sin (* p1__88084# 0.3))) (range 30))}))
 ...
 (let
  ...
  (with-open
   ...
   (let
    [bs (byte-array 8)]
    (.read in bs)
    (mapv (fn* [p1__88086#] (bit-and p1__88086# 255)) (vec bs))))))
 ...
 (let
  ...
  (with-open
   ...
   (let
    [bs (byte-array 4)]
    (.read in bs)
    (mapv (fn* [p1__88087#] (bit-and p1__88087# 255)) (vec bs))))))
