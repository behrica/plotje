    ...
    (and
     ...
     (let
      ...
      (and
       ...
       (every?
        (fn* [p1__88111#] (= :petal-length (:x p1__88111#)))
        layers)
       (every?
        (fn* [p1__88112#] (= :petal-width (:y p1__88112#)))
        layers)
       (every?
        (fn* [p1__88113#] (= :species (:color p1__88113#)))
        layers)))
     (= {} (:opts d))))
   v14_l200)))
  ...
  ((fn
    ...
    (and
     ...
     (every?
      (fn*
       [p1__88114#]
       (.startsWith (.getName (class p1__88114#)) "membrane.ui."))
      (:drawables v))))
   v27_l258)))
    ...
    (let
     ...
     (and
      ...
      (=
       ...
       (count
        (filter
         (fn* [p1__88115#] (.startsWith p1__88115# "rgb"))
         (:colors s)))))))
   v40_l436)))
