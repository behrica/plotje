...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__90707#] (Math/sin (* p1__90707# 0.3))) (range 30))}))
 ...
 (let
  ...
  (with-open
   ...
   (let
    [bs (byte-array 8)]
    (.read in bs)
    (mapv (fn* [p1__90709#] (bit-and p1__90709# 255)) (vec bs))))))
 ...
 (let
  ...
  (with-open
   ...
   (let
    [bs (byte-array 4)]
    (.read in bs)
    (mapv (fn* [p1__90710#] (bit-and p1__90710# 255)) (vec bs))))))
