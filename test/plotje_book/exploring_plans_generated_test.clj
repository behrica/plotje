...
(deftest
 ...
 (is
  ((fn
    ...
    (and
     (= 3 (count gs))
     (every? (fn* [p1__88264#] (= 50 (:n-points p1__88264#))) gs)))
   v49_l177)))
 ...
 (is
  ((fn
    ...
    (and
     (> (count bars) 3)
     (every?
      (fn* [p1__88265#] (< (:lo p1__88265#) (:hi p1__88265#)))
      bars)
     (every? (fn* [p1__88266#] (pos? (:count p1__88266#))) bars)))
   v74_l248)))
...
(def
 ...
 (def
  ...
  {:x (range 30),
   :y
   (map (fn* [p1__88267#] (Math/sin (* p1__88267# 0.3))) (range 30))}))
