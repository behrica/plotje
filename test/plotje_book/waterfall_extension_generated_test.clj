  ...
  ((fn
    ...
    (let
     [s
      ...
      [0.85 0.25 0.25 1.0]
      positive-bars
      (mapv (fn* [p1__93162#] (nth waterfall-bars p1__93162#)) [0 2 5])
      negative-bars
      (mapv
       (fn* [p1__93163#] (nth waterfall-bars p1__93163#))
       [1 3 4])]
     (and
      (= 1 (:panels s))
      (= 6 (:polygons s))
      (every?
       (fn* [p1__93164#] (= green (:color p1__93164#)))
       positive-bars)
      (every?
       (fn* [p1__93165#] (= red (:color p1__93165#)))
       negative-bars))))
   v17_l164)))
